...
do -- Example UI
	local Window = library:AddWindow("Toaster Internal", {
		main_color = Color3.fromRGB(41, 74, 122),
		min_size = Vector2.new(679, 392),
		toggle_key = Enum.KeyCode.RightShift,
		can_resize = true,
	})
...
local Tabber = Window:AddTab("Scripts")
	...
	do -- Elements
		...
		Console:Set("--Welcome to Toaster Internal")
		print(Console:Get())
		...
		Tabber:AddLabel("Universal")
		Tabber:AddButton("Infinite Yield", function()
			loadstring(game:HttpGet(('https://pastebin.com/raw/tzTXmYf2'),true))()
		end)
		
		
Tabber:AddButton("Dex", function()
			loadstring(game:HttpGet(('https://pastebin.com/raw/Ht4zRXj8'),true))()
		end)
		
		
Tabber:AddButton("Nullware", function()
			loadstring(game:HttpGet(('https://pastebin.com/raw/sbMD3D7D'),true))()
		end)
		
		
Tabber:AddButton("EZ Hub", function()
			loadstring(game:HttpGet(('https://raw.githubusercontent.com/debug420/Ez-Industries-Launcher-Data/master/Launcher.lua'),true))()
		end)


Tabber:AddLabel("Games")
		Tabber:AddButton("Word Bomb", function()
			loadstring(game:HttpGet("https://raw.githubusercontent.com/EGX3/GAMES/main/Word%20bomb"))()
		end)
