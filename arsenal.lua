...
local s = VLib:Window("Toaster Hub", "skidded by delux", "B")
...
Credits:Button('Toaster Discord',function()
	setclipboard("https://discord.gg/zKgxfq2szk")
end)


Credits:Label('Toaster Hub')
Credits:Label('By: Delux and Cim')



local Notification = loadstring(game:HttpGet("https://raw.githubusercontent.com/Jxereas/UI-Libraries/main/notification_gui_library.lua", true))()

Notification.new("info", "Toaster Hub", "Game Detected - Arsenal") -- Args(<string> Type, <string> Heading, <string> Body, <boolean?> AutoRemoveNotif, <number?> AutoRemoveTime, <function?> OnCloseFunction)
